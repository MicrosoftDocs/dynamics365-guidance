...
The solution is based on Dynamics 365 Sales, Customer Services, and Customer Insights connected to one or more Travel and Hospitality platforms. The product catalog (stays, trains, flights) is retrieved from the non-Microsoft travel and hospitality platform.
...
The key stakeholders required in this solution architecture are sales representatives, customer service representatives, marketing representatives, IT representatives.
...
| 6 | Content Management | Content management System (Can be Power Pages or other) | Dynamics 365 | Landing pages, Event Pages</br>Subscription centers</br>Web sites | Content management to be used by Dynamics Marketing |
...
- Dynamics 365 Customer Services manages client questions

- DCCP Omnichannel features communicate with the customer on every channel

- Dynamics 365 Marketing manage the communication campaigns and events

- Power Pages are a customer portal with personal space

- Azure AD manages internal user identities
...
- Microsoft Outlook and Teams helps businesses communicate

- The travel and hospitality platform is a product repository and CPQ tool to browse for available stays offerings. This platform produces, administrates, distributes, and manages offers on every distribution channel
...
This reference architecture may apply in a scenario where an existing company with an existing business-to-consumer (B2C) business has a significant number of customers and wishes to complete its offerings with travel and vacations. For example, a car rental company has offices worldwide and has customers created in all these offices. The company can enrich its offerings with vacations and stays offerings. This way the customer calling for a car rental can book a hotel room at the same time. The company doesn't have any hotels of its own but can use existing platforms who already have partnerships with hotel chains and other vacation offering companies and provide theses products. This way the car rental company can become a reseller of the stays. The Data Quality Management platform is a must have for every B2C business nowadays.

### Potential use cases

This solution was created for a B2C organization wanting to become a reseller of stays but isn't the owner of the hotels. It can also be applied to industries like travel or companies from other industry wanting to extend their activities with travel. It can be used by any organization who wants to combine its current activities with travel without acquiring the hotels or the traveling companies. They can use specialized platforms to get access to traveling offerings including stays and transportation.

You can use this solution to:

- Add traveling in your offering without investing into hotels

- Use a large number of offerings provided by specialized companies who have partnerships with major hotel chains etc.
...
*Products:* Dynamics 365 Customer Insights, Dynamics 365 Customer Service, Dynamics 365 Customer Service Insights, Dynamics 365 Customer Voice, Dynamics 365 Marketing, Dynamics 365 Sales -->
