...
1. Sync data between Dataverse and the database with finance and operations data by using [dual-write](/dynamics365/fin-ops-core/dev-itpro/data-entities/dual-write/dual-write-overview) or other integration engines.
