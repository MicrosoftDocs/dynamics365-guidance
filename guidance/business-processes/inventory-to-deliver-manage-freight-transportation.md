...
# Overview of the Manage freight and transportation business process area within the Inventory to deliver end-to-end scenario
...
1. *Manage freight and transportation* (the article that you're currently reading)

    1. *Plan loads*  
    1. *Rate loads*  
    1. *Route loads*  
    1. *Schedule dock appointments*  
    1. *Print shipping documentation*
    1. *Process freight invoices*  
    1. *Reconcile freight*
