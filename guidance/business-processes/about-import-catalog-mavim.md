...
# Import the business process catalog in Mavim using a Power Automate flow
  ...
  > [!IMPORTANT]
   > This article documents the process for importing the business process catalog with before the March 2026 release. If you want to use the March 2026 or newer versions, go to the [Import the Business Process Catalog using the Mavim Database](about-import-catalog-mavim-database.md) article.
